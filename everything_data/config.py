load_zone_county_mapping = {
      "ERCOT": {
            "North": {"Core1":["Dallas","Collin","Denton"],
            ...
            "South": {"Core1":["Austin","Washington","Waller"], 
                  "Core2":["Bexar"],
                  "Core3":["Hidalgo"],
                  "Core4":["San Patricio"]
...
weather_zone_county_mapping = {
      "ERCOT": {
            ...
            "Far West": {"Core1":["Midland"],
                  },
            "West": {"Core1":["Taylor"]},
            "South":{"Core1":["Hidalgo"], "Core2":["San Patricio"]},
            "Coast":{"Core1":["Harris","Fort Bend","Montgomery"]},
            "South Central":{"Core1":["Austin","Washington","Waller"], "Core2":["Bexar"]},
            "North Central":{"Core1":["Dallas","Collin","Denton"], "Core2":["Fort Worth","Tarrant","Ellis"]},
            "East":{"Core1":["Smith"]},
...
ERCOT_PRICE_DATA_ADDRESS_LIST = ["https://www.ercot.com/misdownload/servlets/mirDownload?doclookupId=1140421628",
